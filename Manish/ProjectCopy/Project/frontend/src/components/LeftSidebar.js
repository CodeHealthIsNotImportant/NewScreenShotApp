...
const LeftSidebar = () => {
    ...
    return (
        <div className='w-[20%]'>
            <div>
                <div>
                    <img className='ml-5' width={"24px"} src="https://images.squarespace-cdn.com/content/v1/6636a8a240efc07873f1dbe4/35e2b4ed-6190-4f5f-87cc-391fcf4983a4/nexplaysecure_transparent.PNG?format=1500w" alt="nxpsecure-logo" />
                </div>
                <div className='my-4'>
